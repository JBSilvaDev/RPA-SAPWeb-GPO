...
class SapD_1(SapController):
    ...
    def sap_menu_ambiente(self):
        ...
        ambiente = self.wait_elements('/html/body/table/tbody/tr/td/div/div/div/div[2]/span[1]/div/div[2]/table/tbody/tr[6]/td[3]')
        hover = self.action_chains.move_to_element(ambiente)
        hover.perform()
        time.sleep(2)
        area_de_trabalho = self.wait_elements('/html/body/table/tbody/tr/td/div/div/div/div[2]/span[20]/div/div[2]/table/tbody/tr[1]/td[3]/span')
    ...
    def sap_page_action(self):
        ...
        self.wait_elements('//*[@id="M0:46:::5:34"]').send_keys(f'{self.hoje}.{self.mes}.20{self.ano}')
        self.wait_elements('//*[@id="M0:46:::5:59"]').send_keys(f'{self.hoje}.{self.mes}.20{self.ano}')
    ...
    def sap_download_csv(self):
        print('Inciando processo de download d-1')
        self.wait_elements('//*[@id="cua2sapmenu_btn"]').click()
        self.wait_elements('/html/body/table/tbody/tr/td/div/div/div[1]/div[2]/span[1]/div/div[2]/table/tbody/tr[1]/td[3]').click()
        self.wait_elements('/html/body/table/tbody/tr/td/div/div/div[1]/div[2]/span[5]/div/div[2]/table/tbody/tr[4]/td[3]').click()
        self.wait_elements('/html/body/table/tbody/tr/td/div/div/div[1]/div[2]/span[3]/div/div[2]/table/tbody/tr[3]/td[3]/span').click()
        time.sleep(5)
